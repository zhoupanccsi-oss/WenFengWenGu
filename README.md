...
AIGC:
  ...
  Label: '1'
  ProduceID: '33d33ef1-48af-4831-aa74-b9e5198eef4b'
  PropagateID: '33d33ef1-48af-4831-aa74-b9e5198eef4b'
  ReservedCode1: 'd5b952ee-aba9-4968-8ae2-759d276840b6'
  ReservedCode2: 'd5b952ee-aba9-4968-8ae2-759d276840b6'
---

# 文峰文谷 (WenFengWenGu)

峰谷时段实时提醒 Android App —— 屏幕四边动态彩色边框，后台运行不中断。
...
如果需要签名，可在 `app/build.gradle` 的 `signingConfigs` 中添加密钥。
